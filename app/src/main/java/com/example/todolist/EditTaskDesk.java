...
public class EditTaskDesk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // getting value from the previous page
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("todo-list").
                ...
                reference.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(EditTaskDesk.this, "Failure !", Toast.LENGTH_SHORT).show();
                        }
